        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-3 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-7">
            ...
            <li className="text-base font-semibold text-gray-500 hover:text-gray-900 mt-1 list-none cursor-pointer">
              <Link to="eligibility" spy={true} smooth={true} offset={50} duration={500} delay={100}>
                Eligibility
              </Link>
            </li>
            <li className="text-base font-semibold text-gray-500 hover:text-gray-900 mt-1 list-none cursor-pointer">
              <Link to="timeline" spy={true} smooth={true} offset={50} duration={600} delay={100}>
                Timeline
              </Link>
            </li>
            <li className="text-base font-semibold text-gray-500 hover:text-gray-900 mt-1 list-none cursor-pointer">
              <Link to="teams" spy={true} smooth={true} offset={50} duration={700} delay={100}>
                Teams
              </Link>
            </li>
            <li className="text-base font-semibold text-gray-500 hover:text-gray-900 mt-1 list-none cursor-pointer">
              <Link to="gallery" spy={true} smooth={true} offset={50} duration={800} delay={100}>
               Gallery
              </Link>
            </li>
            <li className="text-base font-semibold text-gray-500 hover:text-gray-900 mt-1 list-none cursor-pointer">
              <Link to="rules" spy={true} smooth={true} offset={50} duration={900} delay={100}>
                Rules
              </Link>
            </li>
            <li className="text-base font-semibold text-gray-500 hover:text-gray-900 mt-1 list-none cursor-pointer">
              <Link to="contact" spy={true} smooth={true} offset={50} duration={1000} delay={100}>
                Contact
              </Link>
            </li>
            <li
                  ...
                  {solutions.map((item) => (
                    ...
                    >
                      <span className="ml-3 text-base font-medium text-gray-700 cursor-pointer">
                        <Link to={item.to} spy={true} smooth={true} offset={50} duration={item.duration} delay={100}>
                          {item.name}
                        </Link>
                      </span>
                    </li>
