    ...
    return (
        <div className="md:w-1/2 lg:w-96 p-4 bg-white border-inherit h-52 border rounded-lg mr-5 mb-5">
            ...
            <div className="p-4 pt-0 pl-2">
                <p className="text-gray-900 text-base font-medium mb-1">{props.member01}</p>
                <p className="text-gray-900 text-base font-medium mb-1">
                    {props.member02}
                </p>
                <p className="text-gray-900 text-base font-medium mb-1">{props.member03}</p>
                <p className="text-gray-900 text-base font-medium mb-1">{props.member04}</p>
            </div>
        </div>
    );
};
